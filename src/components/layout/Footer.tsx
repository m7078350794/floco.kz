        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex items-center gap-4 mt-6">
              ...
              {settings?.whatsappPhone && (
                <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="text-text-muted hover:text-primary transition-colors">
              ...
              {city === 'tashkent' && (
                <a href={settings?.telegramUrl || "https://t.me/floco_tashkent"} target="_blank" rel="noopener noreferrer" className="text-text-muted hover:text-primary transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-text-secondary">
              {settings?.whatsappPhone && (
                <li>
                  <a href={`tel:+${settings.whatsappPhone}`} className="hover:text-primary transition-colors">
                    +{settings.whatsappPhone}
                  </a>
                </li>
              )}
