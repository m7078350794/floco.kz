    ...
    <section className="py-20 md:py-28 bg-surface" id="contacts" ref={ref}>
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          >
            <div className="w-14 h-14 rounded-full bg-[#25D366]/10 text-[#25D366] flex items-center justify-center mb-4 group-hover:bg-[#25D366] group-hover:text-white transition-all duration-300">
          ...
          <a
            ...
            className="flex flex-col items-center p-8 rounded-[var(--radius-card)] bg-cream/50 hover:bg-cream transition-colors duration-300 group"
          >
            <div className="w-14 h-14 rounded-full bg-rose/20 text-rose flex items-center justify-center mb-4 group-hover:bg-gradient-to-br group-hover:from-[#833AB4] group-hover:via-[#FD1D1D] group-hover:to-[#F77737] group-hover:text-white transition-all duration-300">
              <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24">
